        ...
        while(True):
            ...
            if (is_done == True):
                ...
                if numEpisodes % 500 == 1:
                    ...
                    self.QNet.save_model("model_linear_replay_MC.json")
                    self.QNet.save_model_weights("model_linear_replay_MC.h5")
...
#                target_model.set_weights(self.model.get_weights())
            ...
            if (done ==True):
                ...
                if(done_count==20):
                    ...
                    if (abs(avg_reward) < abs(self.max_test_reward)):
                        ...
                        self.QNet.save_model_weights("best_weights_linear_replay_MC.h5")
                    reward_count=0
                    done_count=0
    ...
    def write_test_results(self, filename="linear_replay_MC_test_results"):
